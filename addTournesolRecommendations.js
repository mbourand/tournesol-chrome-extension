  ...
  var timer = window.setInterval(function () {
    ...
    */
    ...
    try
    {
      ...
      contents = document.getElementById('visibility-monitor').parentElement.children[11].getElementsByTagName('ytd-page-manager')[0].getElementsByTagName('ytd-browse')[0].getElementsByTagName('ytd-two-column-browse-results-renderer')[0].children[0].getElementsByTagName('ytd-rich-grid-renderer')[0];
      if (!contents || !contents.children[1])
        return;
    }
    catch (error) { return; }
